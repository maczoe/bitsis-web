    ...
    <div class="container">
        <div class="row">
            <div class=" col-lg-4 col-md-6 col-sm-6">
                <div class="single-services text-center mb-30">
                    <div class="services-ion">
                        <img class="img-fluid" src="assets/img/products/mas_screen.png" alt="mas-screen">
                    </div>
            ...
            <div class=" col-lg-4 col-md-6 col-sm-6">
                <div class="single-services text-center mb-30">
                    <div class="services-ion">
                        <img class="img-fluid" src="assets/img/products/odoo_pos.png" alt="odoo-pos">
                    </div>
                    <div class="services-cap mt-3">
                        <h5>Odoo ERP</h5>
            ...
            <div class=" col-lg-4 col-md-6 col-sm-6">
                <div class="single-services text-center mb-30">
                    <div class="services-ion">
                        <img class="img-fluid" src="assets/img/products/it_consulting.jpg" alt="it-consulting">
                    </div>
                    <div class="services-cap mt-3">
        ...
        <div class="row">
            <div class=" col-lg-4 col-md-6 col-sm-6">
                <div class="single-services text-center mb-30">
                    <div class="services-ion">
                        <img class="img-fluid" src="assets/img/products/web_design.png" alt="web-design">
                    </div>
                    <div class="services-cap mt-3">
                        <h5>Diseño Web</h5>
            ...
            <div class=" col-lg-4 col-md-6 col-sm-6">
                <div class="single-services text-center mb-30">
                    <div class="services-ion">
                        <img class="img-fluid" src="assets/img/products/consultoria.jpg" alt="consultoria">
                    </div>
                    <div class="services-cap mt-3">
            ...
            <div class=" col-lg-4 col-md-6 col-sm-6">
                <div class="single-services text-center mb-30">
                    <div class="services-ion">
                        <img class="img-fluid" src="assets/img/products/fel.jpg" alt="log-fel">
                    </div>
                    <div class="services-cap mt-3">
