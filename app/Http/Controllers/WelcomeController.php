...
class WelcomeController extends Controller
{
    ...
    private function generateSlides() {
        $slides = [];
        $slide = new Slide();
        $slide->image = asset('assets/img/hero/hero_img.jpg');
        ...
        $slides[0] = $slide;
        $slide2 = new Slide();
        $slide2->image = asset('assets/img/hero/hero_img2.jpg');
        ...
        $slides[1] = $slide2;
        $slide3 = new Slide();
        $slide3->image = asset('assets/img/hero/hero_img.jpg');
        ...
        $slides[2] = $slide3;
        $slide4 = new Slide();
        $slide4->image = asset('assets/img/hero/hero_img2.jpg');
